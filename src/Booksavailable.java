...
public class Booksavailable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 640, 370));

        fetch.setBackground(new java.awt.Color(255, 255, 102));
        fetch.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        fetch.setText("FETCH");
        ...
        getContentPane().add(fetch, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 400, 104, 29));
        ...
        getContentPane().add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 400, 95, 29));
